...
function Footer() {
  return (
    <footer className="mt-16 bg-green-500">
      <div className="border-t md:px-4 md:pt-10 md:pb-5">
        <div className="flex flex-wrap md:max-w-screen-lg mx-auto">
          <section className="relative text-gray-100 font-light font-light border-b px-4 pb-4 md:py-3 w-full md:border-none md:w-1/4">
      ...
      <div className="max-w-screen-lg mx-auto border-none px-4">
        <section className="flex flex-col md:flex-row md:justify-between md:border-solid md:border-t text-gray-200 font-light text-sm pt-4 pb-6 md:pt-5 md:pb-6 w-full">
          <div>
            <p className="leading-8 tracking-wide">
              &copy; {new Date().getFullYear()} Gelmox Group., 106 Ojuelegba Road, Surulere, LGS
            </p>
          </div>
          <div>
